...
- with_skill: SKILL.md is prepended to the prompt so the agent has the
  fast-tests guidance in context.
...
SKILL_SECTION_WRAPPER = """## Skill available: fast-tests

You have the fast-tests skill available. Apply its guidance to every user request. The skill content:

#!/usr/bin/env python3
"""Grade fast-tests skill eval responses.
...
GRADER_PROMPT_TEMPLATE = """You are a grader for the fast-tests skill evals. Evaluate whether an agent's response satisfies a list of assertions.
